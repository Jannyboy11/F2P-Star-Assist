...
public class DoubleHoppingTilesOverlay extends Overlay {
    ...
    private static final DoubleHoppingTile[] doubleHoppingTiles = {
            ...
            //new DoubleHoppingTile("Desert mine / Duel Arena hopping location", new WorldPoint(3318, 3282, 0)), //TODO find out whether there is a double hopping spot for the PvP arena!
